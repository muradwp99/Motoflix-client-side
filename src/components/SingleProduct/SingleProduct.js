...
const SingleProduct = () => {
    ...
    useEffect(() => {
        const getProduct = async () => {
            await axios.get(`https://limitless-springs-08702.herokuapp.com/inventory/${inventoryId}`)
    ...
    const handleDelivered = async () => {
        ...
        await axios.put(`https://limitless-springs-08702.herokuapp.com/inventory/${inventoryId}`, newData)
        axios.get(`https://limitless-springs-08702.herokuapp.com/inventory/${inventoryId}`)
            .then(response => {
    ...
    const hanldeRestock = async (e) => {
        ...
        await axios.put(`https://limitless-springs-08702.herokuapp.com/inventory/${inventoryId}`, newReStockQuantity)
        axios.get(`https://limitless-springs-08702.herokuapp.com/inventory/${inventoryId}`)
            .then(response => {
                setProduct(response.data)
